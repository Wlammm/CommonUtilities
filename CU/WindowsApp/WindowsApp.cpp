...
#define ConsoleOutput(x) _RPT0(_CRT_WARN, x);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    while (GetMessage(&msg, nullptr, 0, 0))
    {
        ...
        {
            ConsoleOutput("S Down\n");
        }

        if (myInput.IsKeyUp('S'))
        {
            ConsoleOutput("S Up\n");
        }

        if (myInput.IsKeyPressed('W'))
        {
            ConsoleOutput("W Pressed\n");
        }
    }
